...
### Ruler marker cleanup
- `AGENTS.md`: removed stale `<!-- Generated by Ruler -->` marker. Repo has no `.ruler/` config and is hand-maintained (per CLAUDE.md "No Ruler here"), so the marker was misleading — nothing regenerates this file.


### Security Hardening (Plan 1)
