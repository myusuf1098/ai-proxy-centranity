...
| **PostgreSQL Connection Refused** | PostgreSQL container starting / down | `docker logs proxygateway-postgres` | Check volume permissions and verify database port 5432 is accessible. |
